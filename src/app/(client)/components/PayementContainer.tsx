...
interface PayementContainerProps {
    goodie: any
    message: () => string
}
const PayementContainer = ({ goodie, message }: PayementContainerProps) => {
    ...
    return (
        <Box paddingX={match700 ? 3 : 12} paddingY={5} style={{ width: "100%", height: "100%" }}>
            <form onSubmit={handleSubmit(onSubmit)} >
                ...
                <div className=" flex flex-row flex-wrap sm:flex-nowrap gap-4  mt-4  h-full w-full">
                    <div className=" flex-auto flex-col 2xl:flex-row flex gap-4 w-[70%] ">
